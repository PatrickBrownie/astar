...
!(function (a) {
  (a.jCarouselLite = { version: "1.1" }),
    (a.fn.jCarouselLite = function (b) {
      return (
        (b = a.extend({}, a.fn.jCarouselLite.options, b || {})),
        this.each(function () {
          function c(a) {
            return (
              n ||
                (clearTimeout(A),
                (z = a),
                b.beforeStart && b.beforeStart.call(this, i()),
                b.circular ? j(a) : k(a),
                m({
                  start: function () {
                    n = !0;
          ...
          function d() {
            if (
              ((n = !1),
              (o = b.vertical ? "top" : "left"),
              (p = b.vertical ? "height" : "width"),
              (q = B.find(">ul")),
              (r = q.find(">li")),
              (x = r.size()),
              (w = x < b.visible ? x : b.visible),
              b.circular)
            ) {
          ...
          function e() {
            B.css("visibility", "visible"),
              s.css({ overflow: "hidden", float: b.vertical ? "none" : "left" }),
              q.css({ margin: "0", padding: "0", position: "relative", "list-style": "none", "z-index": "1" }),
              B.css({ overflow: "hidden", position: "relative", "z-index": "2", left: "0px" }),
          ...
          function g() {
            b.btnPrev &&
              a(b.btnPrev).click(function () {
                return c(z - b.scroll);
              }),
              b.btnNext &&
                a(b.btnNext).click(function () {
                  return c(z + b.scroll);
                }),
              b.btnGo &&
                a.each(b.btnGo, function (d, e) {
                  a(e).click(function () {
